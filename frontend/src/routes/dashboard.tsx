            ...
            <div className="mt-8 grid gap-4 lg:grid-cols-3">
                ...
                >
                    {habits.isLoading ? (
                        ...
                        <p className="text-lg font-bold text-muted-foreground">No Prediction Logged for Today</p>
                    ) : (
                        <>
                            ...
                            <p className="mt-6 text-center text-sm text-muted-foreground">
                                Based on your latest check-in for <span className="font-semibold text-foreground">{activeHabitName}</span>
                            </p>
                        </>
                    )}
                </motion.section>
